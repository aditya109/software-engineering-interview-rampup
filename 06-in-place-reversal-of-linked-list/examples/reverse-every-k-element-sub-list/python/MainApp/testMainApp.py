...
class TestMainApp(unittest.TestCase):
    ...
    def setUp(self):
        ...
        r_root.next.next = ListNode(4)
        r_root.next.next.next = ListNode(3)
        ...
        r_root = ListNode(3)
        r_root.next = ListNode(2)
        r_root.next.next = ListNode(1)
        r_root.next.next.next = ListNode(4)
        r_root.next.next.next.next = ListNode(5)
    ...
    def test_run(self):
        for argument in self._arguments:
            actual_result = self._mainAppInstance.run(argument['head'], argument['k'])
